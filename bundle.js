...
function update(elapsedTime) {
  ...
  var collisions = [];
  pColliding.forEach(function(pair){
    if(
      Math.pow(pair.a.x - pair.b.x, 2) +
      Math.pow(pair.a.x - pair.b.y, 2) <
      15 * 15){
        pair.a.color = 'red'
        pair.b.color = 'green'
      }
